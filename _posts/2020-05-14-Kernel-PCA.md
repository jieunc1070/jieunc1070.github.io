...
## Kernel Trick
![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/kernel_trick.png?raw=true" alt="kernel_trick.png)
...
## Kernel PCA
 ![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/kpca.png?raw=true" alt="kpca.png)
...
plt.show()
```
![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/halfmoon.png?raw=true" alt="halfmoon.png)
...
plt.show()
```
![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/halfmoon_pca.png?raw=true" alt="halfmoon_pca.png)
``` ruby
import numpy as np
...
plt.show()
```
![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/halfmoon_pca_2.png?raw=true" alt="halfmoon_pca_2.png)
...
plt.show()
```
![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/halfmoon_kpca.png?raw=true" alt="halfmoon_kpca.png)
``` ruby
...
plt.show()
```
![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/halfmoon_kpca_2.png?raw=true" alt="halfmoon_kpca_2.png)
...
plt.show()
```
![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/concentric.png?raw=true" alt="concentric.png)
...
plt.show()
```
![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/concentric_pca.png?raw=true" alt="concentric_pca.png)
``` ruby
scikit_kpca = KernelPCA(n_components=1, kernel='rbf', gamma=15)
X_skernpca = scikit_kpca.fit_transform(X)
...
plt.show()
```
![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/concentric_kpca.png?raw=true" alt="concentric_kpca.png)
...
plt.show()
```
![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/swiss.png?raw=true" alt="swiss.png)
...
plt.show()
```
![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/swiss_pca.png?raw=true" alt="swiss_pca.png)
``` ruby
...
plt.show()
```
![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/swiss_rbf.png?raw=true" alt="swiss_rbf.png)
``` ruby
...
plt.show()
```
![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/swiss_poly.png?raw=true" alt="swiss_poly.png)
...
plt.show()
```
![](https://github.com/jieunc1070/jieunc1070.github.io/tree/master/assets/images/post/swiss_lle.png?raw=true" alt="swiss_lle.png)
