...
　그림에서 볼 수 있듯이, SOM을 이용하면 많은 양의 분산을 설명할 수 있습니다. 반면에, PCA를 이용하여 데이터를 파란 축에 projection하면 많은 양의 분산($$D_2$$)이 손실될 것입니다. 따라서 **PCA는 비선형 데이터에 적합하지 않은 한계점을 갖습니다.** 다음 포스팅에서는 PCA의 한계점에 대한 대안으로 사용할 수 있는, Kenel PCA 기법에 대해 알아보겠습니다.
